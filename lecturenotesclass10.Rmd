...
3/8 or 37.5% for blue and 1/8 or 12.5% for white.
...
This is very close to the calculated probability. 
...
We can add the variable using the mutate command. 
